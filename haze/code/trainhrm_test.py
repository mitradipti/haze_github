...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "unet_model_hrm_clear_gt_update.pth")
    print("\nModel saved as 'unet_model_hrm_clear_gt_update.pth'.")

    # Load the trained model
    model.load_state_dict(torch.load("unet_model_hrm_clear_gt_update.pth"))
